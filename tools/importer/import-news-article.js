...
const PAGE_TEMPLATE = {
  name: 'news-article',
  description: 'LG Story news and press release pages with announcements and event coverage',
  urls: [
    'https://www.lg.com/ae/lg-story/news/lg-at-ces-2026/index',
  ],
  blocks: [
    {
      name: 'cards',
  ...
  sections: [
    ...
    },
    {
      id: 'section-2',
      name: 'Article Body',
      selector: ['.main-content .module-editable-content:first-child .inner', '.main-content .module-editable-content .inner'],
      style: null,
      blocks: [],
      defaultContent: ['.image-wrapper img', '.editable-content h2', '.editable-content p'],
    },
    {
      id: 'section-3',
